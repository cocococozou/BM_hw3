...
prop_men = sum(filter(ucb_df,gender=="Male", admit=="Admitted")$freq)/sum(filter(ucb_df,gender=="Male")$freq)

prop_women = sum(filter(ucb_df,gender=="Female", admit=="Admitted")$freq)/sum(filter(ucb_df,gender=="Female")$freq)
